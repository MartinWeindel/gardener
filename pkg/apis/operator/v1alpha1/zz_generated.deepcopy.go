...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GardenDNS) DeepCopyInto(out *GardenDNS) {
	*out = *in
	in.PrimaryDomain.DeepCopyInto(&out.PrimaryDomain)
	if in.SecondaryDomains != nil {
		in, out := &in.SecondaryDomains, &out.SecondaryDomains
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GardenDNS.
func (in *GardenDNS) DeepCopy() *GardenDNS {
	if in == nil {
		return nil
	}
	out := new(GardenDNS)
